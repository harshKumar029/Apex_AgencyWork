...
>>>>>>> d90602401d1c06139f1417587e52cb38e0232611
  ...
  useEffect(() => {
    ...
    if (activeFilter === 'All') {
      ...
      filtered = allLeads.filter(
        (lead) => lead.status && lead.status.toLowerCase() === 'rejected'
      );
    ...
    setVisibleCount(20); // Reset the visible count when filter changes
  ...
  return (
    <div className='w-[95%] m-auto mt-5 mb-28 sm:my-5'>
      ...
      <div className='flex justify-between items-center mb-4'>
        ...
        <button
          className='py-2 px-3 sm:mt-auto sm:border border-[#063E50] flex self-end sm:self-auto gap-2 text-[#063E50] rounded-full'
      ...
      <div className='justify-between items-center mb-4'>
        <div className='w-full sm:w-auto'>
          <div className='space-x-4 overflow-x-auto whitespace-nowrap hide-scrollbar'>
            {['All', 'New', 'Approved', 'Pending', 'Rejected', 'Expire'].map(
              (filter) => (
                <button
                  key={filter}
                  onClick={() => {
                  ...
                  <ul className='grid grid-cols-2 border-t border-[#DEE2E6] justify-items-center items-center'>
                    ...
                    <li
                      className={`px-4 py-2 inline-flex gap-3 items-center font-medium text-lg ${
                        row.status &&
                        ['approved', 'rejected'].includes(row.status.toLowerCase())
...
>>>>>>> 777b62fe33d77e3739b4767937f818147576845b
>>>>>>> d90602401d1c06139f1417587e52cb38e0232611
              <p className='text-gray-600 text-lg pt-20 pb-20'>No Leads Available</p>
            </div>
          )}
        </div>
      </div>
