        ...
        <div className="md:w-[50vw] md:bg-white h-screen rounded-l-[3rem] content-center w-full md:px-7 space-y-14 md:space-y-7">
          ...
          <div className="flex flex-col w-[90%] m-auto justify-between items-start">
            <img
              ...
              alt="ApexLogo"
            />
            <h2 className=" md:self-auto text-[white] md:text-[#525252] text-4xl font-bold mb-6">
              Forgot Password
            </h2>
          </div>
          ...
          <div className="flex flex-col px-6 rounded-t-3xl pt-16 bg-white h-screen md:h-auto  space-y-4 md:space-y-7">
