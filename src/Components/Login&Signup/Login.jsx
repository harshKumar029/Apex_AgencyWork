...
const Login = () => {
  ...
  return (
    ...
    >
{/* <div
  className="mb-6 bg-cover bg-no-repeat bg-center md:bg-blue-primary  flex flex-col md:flex-row h-auto h-screen overflow-hidden "
  style={{
    backgroundImage: `url(${startbg})`,
  }}
> */}
        {/* className="md:bg-blue-primary bg-black flex flex-col md:flex-row h-auto h-screen overflow-hidden" */}
      {/* Left Section */}
        ...
        <div className="md:w-[50vw] md:bg-white h-screen rounded-l-[3rem] content-center w-full md:px-7 space-y-14 md:space-y-7">
          ...
          <div className="flex flex-col w-[90%] m-auto justify-between items-start">
            <img
              ...
              alt="ApexLogo"
            />
            {/* <h2 className="text-[#525252] text-3xl font-bold mb-6">
              Log In to Your Account
            </h2> */}
            <h2 className="text-[#ffffff] md:text-[#525252] text-3xl font-bold md:font-extrabold mb-">
              Log In to Your Account
            </h2>
            <h3 className="text-[#ffffff] md:hidden block text-sm mt-2 font-thin">
            Join our growing community of successful agents.
            </h3>
          </div>
          ...
          <div className="flex flex-col px-6 rounded-t-3xl bg-white h-screen md:h-auto  space-y-4 md:space-y-7">
            <div className=" sm:hidden flex justify-between px-2 py-2 font-bold my-5  bg-[#F5F6F9] rounded-lg">
              <button className=" py-2 px-16 bg-white text-[#232447] text-sm rounded-lg">
                Log in
              </button>
              <button
            ...
            <form onSubmit={handleSubmit} className="space-y-7">
              ...
              <div className="flex justify-end">
                <p
                  ...
                  className="cursor-pointer font-medium text-[#063E50] hover:underline"
                >
                  Forgot Password?
                </p>
              </div>
              ...
              <button
                type="submit"
                className="w-full bg-[#1D61E7] md:bg-blue-primary text-white py-3 md:py-2 px-4 text-lg md:text-base font-semibold rounded-lg hover:bg-[#053748] transition-colors"
