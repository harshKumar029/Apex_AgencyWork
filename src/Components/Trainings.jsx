...
const Trainings = () => {
    ...
    return (
        ...
        //             <div key={video.id} className="border border-[#DEE2E6] rounded-3xl w-[24rem] shrink-0">
        //                 <video className=' w-[100%] rounded-t-3xl' controls>
        ...
        <div className='w-[95%] m-auto my-5'>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 pb-4">
                {trainingVideos.map((video) => (
                    <div key={video.id} className="border border-[#DEE2E6] rounded-3xl">
